...
public class player_controller : MonoBehaviour
{
    ...
    public void walk_execute()
    {
        ...
        // При изменении анимации меняется звук
    ...
    {
        // отключение головы в зависимости от лица
    ...
    public void picking_up(string which)
    {
        ...
        if (which == "Assault57")
        {
            ...
            // Уничтожение объекта при его подборе
            destroy = true;
